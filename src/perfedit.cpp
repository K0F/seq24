...
perfedit::perfedit( perform *a_perf ) 
{
    ...
    m_button_snap->signal_clicked().connect(  sigc::bind<Gtk::Menu *>( sigc::mem_fun( *this, &perfedit::popup_menu), m_menu_snap  ));
    ...
    m_button_bpm->signal_clicked().connect(  sigc::bind<Gtk::Menu *>( mem_fun( *this, &perfedit::popup_menu), m_menu_bpm  ));
    ...
    m_button_bw->signal_clicked().connect(  sigc::bind<Gtk::Menu *>( mem_fun( *this, &perfedit::popup_menu), m_menu_bw  ));
